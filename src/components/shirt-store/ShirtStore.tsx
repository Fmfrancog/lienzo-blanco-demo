...
function ProductPrice({ product, compact = false }: { product: Product; compact?: boolean }) {
  return <div className={`product-pricing ${compact ? "product-pricing--compact" : ""}`} data-testid="product-pricing">
